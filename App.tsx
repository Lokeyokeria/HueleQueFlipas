        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-slate-300 md:text-base">
              Fragancias que huelen a lujo sin pagar de más. Calidad top, larga duración, envío
              24/48h y atención cercana desde San Martín de la Vega, Madrid.
            </p>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            ...
            <h4 className="mt-3 text-xl font-black text-white">Compra fácil y rápida</h4>

            <p className="mt-4 text-sm leading-7 text-slate-300">
              Añade tu perfume al carrito y pulsa el botón de compra. Al hacerlo se abrirá
              WhatsApp para confirmar tu pedido de forma sencilla y segura.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-300">
              Una vez recibido el pago, preparamos tu pedido y normalmente sale en unas 24 horas.
              Después, lo habitual es recibirlo en 24/48h.
            </p>
          </div>

          <div className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            <p className="text-xs font-black uppercase tracking-[0.3em] text-sky-300">Contacto</p>

            <h4 className="mt-3 text-xl font-black text-white">Estamos para ayudarte</h4>
            ...
            <div className="mt-5 space-y-4 text-sm text-slate-300">
              ...
              <p className="leading-7">
                ¿No sabes cuál elegir? Escríbenos y te ayudamos a encontrar el perfume que mejor
                encaja contigo.
              </p>
            </div>
          </div>
